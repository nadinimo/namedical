...
<div class="container">
    <div class="row">
        ...
        <!-- Products on the right using cards -->
        <div class="col-md-9">
            <h2 style="width: 100%; font-family: poppins; margin-bottom: 20px;"><b>Daftar Semua Produk</b></h2>
            ...
            <div class="row">
                ...
                ?>
                <div class="col-sm-6 col-md-3 mb-4"> <!-- Adjusted to fit 4 cards per row -->
                    <div class="card shadow-sm">
                        <img src="image/produk/<?= $row['image']; ?>" class="card-img-top" alt="<?= $row['nama']; ?>">
                        <div class="card-body">
                            <h5 class="card-title"><?= $row['nama']; ?></h5> <!-- Increased font size here -->
                            <p class="card-text"><?= substr($row['deskripsi'], 0, 100); ?>...</p>
                            <h5 class="card-price">Rp. <?= number_format($row['harga']); ?></h5> <!-- Increased font size here -->
                            <div class="row">
                                <div class="col-md-6">
